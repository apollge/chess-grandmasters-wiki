...
interface LastOnlineCounterProps {
  lastOnlineTimestamp: number;
}

export const LastOnlineCounter: React.FC<LastOnlineCounterProps> = memo(
  ({ lastOnlineTimestamp }) => {
  ...
  (prevProps, nextProps) => {
    return prevProps.lastOnlineTimestamp === nextProps.lastOnlineTimestamp;
  }
);
